...
/**
 * Main controler for the playconf module. This module enable to modify the Play! application configuration from a web
 * interface.
 * 
 * @author finalspy
 */
public class PlayConf extends Controller {
    private static boolean              confReadableGlobal = false;
    ...
    private static final String         APP_PATH           = Play.applicationPath + separator + "conf" + separator;
    private static final String         APP_CONF           = APP_PATH + "application.conf";
    private static final String         APP_MESSAGES       = APP_PATH + "messages";
    private static final String         APP_ROUTES         = APP_PATH + "routes";
    private static final String         APP_CONF_BAK       = APP_CONF + ".bak";
    ...
    private static void controlPlayperties() {
        ...
        for (final Map.Entry<String, String[]> e : params.all().entrySet()) {
            if ((e.getValue() != null) && (e.getValue()[0] != null) && (numlinemap != null)
                ...
                // fileperties.set(numlinemap.get(e.getKey()), e.getKey() + "="
                // + e.getValue()[0]);
        ...
        try {
            ...
            while ((strLine = br.readLine()) != null) {
                ...
                if ((file.size() > 0) && strLine.contains("~~~~~")) {
                    ...
                    file.get(file.size() - 1).setId(compt++);
